...
// Ensure platform-specific DMA bus implementation is compiled into this sketch
#if defined(ESP_PLATFORM)
#include <sdkconfig.h>
#if defined(CONFIG_IDF_TARGET_ESP32) || defined(CONFIG_IDF_TARGET_ESP32S2)
#include "platforms/esp32/esp32_i2s_parallel_dma.cpp"
#elif defined(CONFIG_IDF_TARGET_ESP32S3)
#include "platforms/esp32s3/gdma_lcd_parallel16.cpp"
#endif
#endif
